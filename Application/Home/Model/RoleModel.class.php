...
class RoleModel extends BaseModel
{
    ...
    public function getRoleList ($userid)
    {
        ...
        $totalcount = $role->where($where)->count();
        $pageInfo = getPageInfo($totalcount);
        $this->setPageInfo($pageInfo);
        
        $roleList = $role->where($where)
     ...
     */
    public function isAdmin($userid,$roleList = array()){
        
        if (!$roleList || !is_array($roleList)){
            $roleList = $this->getRoleList($userid);
        }
